...
public class LauncherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) v.findViewById(R.id.fragment_launcher_recycler_view);
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder
        ...
        public ActivityHolder(View itemView) {
            super(itemView);
            mNameTextView = (TextView) itemView.findViewById(R.id.list_item_launcher_text);
            mAppImageView = (ImageView) itemView.findViewById(R.id.list_item_launcher_icon);
        ...
        public void bindActivity(ResolveInfo resolveInfo) {
            ...
            Drawable appIconDrawable = mResolveInfo.loadIcon(pm);
            mAppImageView.setImageDrawable(appIconDrawable);
    ...
    private class ActivityAdapter extends RecyclerView.Adapter<ActivityHolder> {
        ...
        public ActivityHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = layoutInflater.inflate(R.layout.app_list, parent, false);
